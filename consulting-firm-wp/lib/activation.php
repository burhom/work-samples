  ...
  <div class="wrap">
    ...
    <form method="post" action="options.php">
      ...
      <table class="form-table">
        <tr valign="top"><th scope="row">Create multiple page or single page site?</th>
          <td>
            <fieldset>
              <legend class="screen-reader-text"><span>Create multiple page or single page site?</span></legend>
              <select name="roots_theme_activation_options[create_front_page]" id="create_front_page">
                <option selected="selected" value="true">Multiple Pages</option>
  ...
  if ($roots_theme_activation_options['create_front_page'] === 'true') {
    ...
    foreach ($pages_to_create as $new_page_title) {
      ...
      $add_default_pages = array(
        ...
        'post_content' => 'Enter page content here...',
        'post_status' => 'publish',
        'post_type' => 'page',
        'menu_order' => $i
      );
