 ...
 * 1. jquery-1.10.2.min.js via Google CDN (in footer)
 * 2. /theme/assets/js/vendor/modernizr-2.7.0.min.js
 * 3. /theme/assets/js/plugins.min.js (in footer)
 * 4. /theme/assets/js/main.min.js (in footer)
 */
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/app.css', false, null);
  ...
  wp_register_script('plugins', get_template_directory_uri() . '/assets/js/plugins.min.js', array(), null, true);
